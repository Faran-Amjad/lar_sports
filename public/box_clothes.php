...
<html>
<head>
	<title>Update Boxing Clothes</title>
...
function saveimage($name,$image,$price)
    {
        ...
        $qry="INSERT into box_clothes(name,image,price) VALUES('$name','$image','$price')";
...
function displayimage()
   ...
   <?php      echo '<td>'.$row[2].'</td>'; 
                echo '<td>'.$row[3].'</td>';
   ?>
            <td> <a href="main_reg.php?b_c_delete=<?php echo $row[0];?>" class="btn btn-danger"> Delete </a></td>
             <!--var_dump($row[3]);-->
