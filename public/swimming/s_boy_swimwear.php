...
function saveimage($name,$image,$price)
    {
        ...
        $qry="INSERT into s_boy_swimwear(name,image,price) VALUES('$name','$image','$price')";
...
function displayimage()
   ...
   <?php      echo '<td>'.str_replace(".PNG", '', $row[2]).'</td>'; 
                echo '<td>'.$row[3].'</td>';
   ?>
            <td> <a href="main_reg.php?s_b_s_delete=<?php echo $row[0];?>" class="btn btn-danger"> Delete </a></td>
             <!--var_dump($row[3]);-->
