...
<body>
  ...
  <div id="container">
    ...
    <div id="signup">
      ...
      <div id="boxing">
       <table align="center">   
        <tr >
          <td><a href="JavaScript:void(0);" onclick="toggle_visibility('boxing','box_clothing');"><img src="boxing/Clothing.png"></a></td>
    ...
    <div id="cricket">
      ...
      <table align="center">   
        <tr >
          <td><a href="JavaScript:void(0);" onclick="toggle_visibility('cricket','cric_equipments');"><img src="cricket/Batting Equipment.png"></a></td>
    ...
    <div id="athletics">
      athletics
        <table align="center">
      <tr >
          <td><a href="JavaScript:void(0);" onclick="toggle_visibility('athletics','ath_Activity_Trackers');"><img src="athletics/Activity Trackers.png"></a></td>
 ...
 <div id="ath_Activity_Trackers">
    ...
    <div id="swimming">
      ...
      <table align="center">
      <tr >
          <td><a href="JavaScript:void(0);" onclick="toggle_visibility('swimming','swim_b_swimwear');"><img src="swimming/Boy's Swimwear.png"></a></td>
...
<script type="text/javascript">
       ...
       function display_swim_b_swimwear()
    {
      ...
      $mysqli= new mysqli('localhost','root','','crud') or die(mysqli_error($mysqli));
        //mysql_select_db("testing",$con);
      $qry="select * from s_boy_swimwear";
      $result=mysqli_query($mysqli,$qry);
      $c=0;
      echo'<table align="center"><tr>';
